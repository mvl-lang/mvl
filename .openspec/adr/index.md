...
| [0063](0063-test-crate-main-exclusion-backend-parity.md) | Test-crate `fn main` exclusion — LLVM/WASM parity, entry file and sibling files both dropped before emission | Accepted |
| [0064](0064-wasm-browser-target-js-host-reuse.md) | `wasm-browser` target — maximize host reuse, minimize bespoke bridge code; cfg-gated `runtime/wasm` over a hand-rolled JS WASI shim, `wasm-bindgen` rejected | Accepted |
