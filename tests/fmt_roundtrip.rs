...
fn roundtrip_expressions() {
    let src = include_str!("fixtures/01_syntax/expressions.mvl");
...
fn roundtrip_functions() {
    let src = include_str!("fixtures/02_functions/functions.mvl");
...
fn roundtrip_statements() {
    let src = include_str!("fixtures/01_syntax/statements.mvl");
...
fn roundtrip_refinements() {
    let src = include_str!("fixtures/03_types/refinements.mvl");
