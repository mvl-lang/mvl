...
fn lint_clean_program_no_warnings() {
    let src = include_str!("corpus/14_linting/clean_program.mvl");
...
fn lint_complexity_cyclomatic() {
    let src = include_str!("corpus/14_linting/complexity_demo.mvl");
...
fn lint_unreachable_code() {
    let src = include_str!("corpus/14_linting/unreachable_code.mvl");
    assert_lint_has_rule(src, "unreachable-code", "unreachable_code.mvl");
}

#[test]
fn lint_missing_totality() {
    let src = include_str!("corpus/14_linting/missing_totality.mvl");
...
fn lint_redundant_effects() {
    let src = include_str!("corpus/14_linting/redundant_effects.mvl");
...
fn lint_for_iter_antipattern() {
    let src = include_str!("corpus/14_linting/for_iter_antipattern.mvl");
    assert_lint_has_rule(src, "for-iter-antipattern", "for_iter_antipattern.mvl");
}

#[test]
fn lint_while_to_for_range() {
    let src = include_str!("corpus/14_linting/while_to_for_range.mvl");
...
fn lint_naming_conventions_clean() {
    let src = include_str!("corpus/14_linting/naming_conventions.mvl");
...
fn lint_all_corpus_files_parse_cleanly() {
    let files: &[(&str, &str)] = &[
        (
            "clean_program",
            include_str!("corpus/14_linting/clean_program.mvl"),
        ),
        (
            "complexity_demo",
            include_str!("corpus/14_linting/complexity_demo.mvl"),
        ),
        ("fn_length", include_str!("corpus/14_linting/fn_length.mvl")),
        (
            "for_iter_antipattern",
            include_str!("corpus/14_linting/for_iter_antipattern.mvl"),
        ),
        (
            "missing_totality",
            include_str!("corpus/14_linting/missing_totality.mvl"),
        ),
        (
            "naming_conventions",
        ...
        (
            "redundant_effects",
            include_str!("corpus/14_linting/redundant_effects.mvl"),
        ),
        (
            "redundant_match",
            include_str!("corpus/14_linting/redundant_match.mvl"),
        ),
        (
            "trailing_whitespace",
            include_str!("corpus/14_linting/trailing_whitespace.mvl"),
        ),
        (
            "unreachable_code",
            include_str!("corpus/14_linting/unreachable_code.mvl"),
        ),
        (
            "while_to_for_range",
            include_str!("corpus/14_linting/while_to_for_range.mvl"),
        ),
    ];
