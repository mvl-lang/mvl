...
impl Codegen {
    ...
    pub fn emit_program_with_mods(&mut self, prog: &Program, sibling_mods: &[&str]) {
        self.emit_program_core(prog, sibling_mods, false);
    }
    ...
    fn emit_program_core(&mut self, prog: &Program, sibling_mods: &[&str], force_runtime: bool) {
        // File header
